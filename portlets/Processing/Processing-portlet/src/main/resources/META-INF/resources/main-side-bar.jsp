	...
	<div id="accordion">
		<div class="card card-main-menu">
				...
				<h5 class="mb-0">
					<button class="btn btn-link2 procesing-tools-text"
						...
						<div class="row">
							...
							<p class="col-md-8" style="text-align: center;margin: auto;font-size: larger;">PROCESSING TOOLS</p>
							<div class="col-md-2">
			...
			<div id="collapseOne" class="collapse show"
				...
				<div class="card-body">
					<div class="col-md">
						<c:if test="${ROLE == 'Administrator' || ROLE == 'Algorithm Developer'}">
							<div class="row processing-cots">
								<img class="card-img-top img-cots" style="max-width: 50%;  flex: 0 0 auto;"
									src="<%=request.getContextPath()%>/media/eclipse-che.png"
									alt="Card image cap">
								<button onclick="showHide('Che')"
									style="height: 27px; margin: auto; max-width: 50%;  flex: 0 0 auto;" class="btn read-more col-md-6">Use
									Eclipse</button>
							</div>
							<div class="row processing-cots">
								<img class="card-img-top img-cots " style="max-width: 50%;  flex: 0 0 auto;"
									src="<%=request.getContextPath()%>/media/jupyter.png"
									alt="Card image cap">
								<button onclick="showHide('Jupyter')"
									style="height: 27px; margin: auto; max-width: 50%;  flex: 0 0 auto;" class=" col-md-6 btn read-more">Use
									Jupyter</button>
							</div>
						</c:if>
						...
						<h5 class="mb-0">
							<button class="btn btn-link2 collapsed algorithm-store-text"
								...
								onclick="showHide('catalogue')">
								   <div class="row">
										<p class="col-md-10" style="text-align: center;margin: auto;font-size: larger;">ALGORITHM STORE</p>
										<div class="col-md-2">
...
//When we collapse, we activate the positions of the arrow
	...
	$('#collapseOne').on('show.bs.collapse', function () {
		$('#processingArrow').attr('src',"<%=request.getContextPath()%>/media/up-arrow.png");
		$('#catalogueArrow').attr('src',"<%=request.getContextPath()%>/media/down-arrow.png");
	})
		
	$('#collapseTwo').on('show.bs.collapse', function () {
		$('#processingArrow').attr('src',"<%=request.getContextPath()%>/media/down-arrow.png");
		$('#catalogueArrow').attr('src',"<%=request.getContextPath()%>/media/up-arrow.png");
			})
</script>
<style>
#accordion {
