<div class="Welcome-Template" id="main-content" role="main">

	<!-- First row for the video -->
	...
	<!-- Second divided in three columns -->
	<div class="portlet-layout row">
		<div class="col-md-1 portlet-column portlet-column-first"
			id="column-2">$processor.processColumn("column-2",
		...
		<div class="col-md-1 portlet-column portlet-column-last" id="column-6">
