package com.esa.maap.usermanagement.impl;
...
/**
 * BmapUser service used to request the back end to add or delete a user
 * 
 * @author tkossoko
 *
 */
...
public class BmapUserServiceImpl implements BmapUserServiceInterface {
	...
	public void setDataCommonLocalService(Common commonService) throws BmapException {
		...
		this.errorMessage = commonService.getValueFromKeyInPropertiesFile("back_end_error_global");
