	...
	<div class="categorySubContainer">
		...
		<div id="coordinates">
			...
			<div style="margin: auto;" class="row">
				...
				<button type="button" onclick="drawboundingbox();"
			...
			<div id="customPoints">
				...
				<div class="text-center">
					<button type="button" onclick="addbtnlocation()" id="addBtnLocation" name="addbtn" value="Add"
			...
			<div>
				<button id="deleteCoordinates" type="button" onclick="deletecoordinates();"
